...
def login(msg_received):
    ...
    if len(records) == 0:
        ...
        return "success"
try:
    ftl_db = mysql.connector.connect(host="localhost", user="root", passwd="12345", database="ftl_db")
except:
    sys.exit("Error connecting to the database. Please check your inputs.")
db_cursor = ftl_db.cursor()
